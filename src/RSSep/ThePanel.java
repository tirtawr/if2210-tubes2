...
public class ThePanel extends JPanel {
	...
	private static final Color BG_COLOR = new Color(0xededed);
	...
	/**
	 * Method to set action to panels
	 * @param action
	 */
	public void setAction(Runnable action) {this.action = action;}
	
	/**
	 * Method to make action enabled
	 */
	public void enableAction() {actionEnabled = true;}
	
	/**
	 * Method to make action disabled
	 */
	public void disableAction() {actionEnabled = false;}

	/**
	 * Method to show border while sliding
	 */
	...
	/**
	 * Method to hide border while sliding
	 */
